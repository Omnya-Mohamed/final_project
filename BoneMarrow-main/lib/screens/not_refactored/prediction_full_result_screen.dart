...
import 'package:g_project/screens/not_refactored/prediction_patient_record_screen.dart';
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                Text("Result : ${widget.result}", style: greyTextStyle),
                Text("Patient Name : ${widget.predictionName} ",
                    style: greyTextStyle),
                Text("Patient Age : ${widget.age}", style: greyTextStyle),
                Text("Gender : ${widget.gender}", style: greyTextStyle),
                Text("Address : ${widget.address}", style: greyTextStyle),
